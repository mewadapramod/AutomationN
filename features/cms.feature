Feature: CMS
  ...
  Scenario: Home page creation with blank layout and verify on frontend
    ...
    And User fill Name Title access level as "Public,Logged In" under setting page and click on save button
		And user drag "Welcome Carousel" from widget section to page
		Then User start editing "Welcome Carousel"
		And user drag "Feature Set" from widget section to page
		Then User start editing "Feature Set"
		And user drag "Image Gallery" from widget section to page
		Then User start editing "Image Gallery" 
		And user drag "Content Box" from widget section to page
		Then User start editing "Content Box"
		And user drag "Typeform" from widget section to page
		Then User start editing "Typeform"
		And user drag "PDF Document" from widget section to page
		Then User start editing "PDF Document"
		And user drag "Video Player" from widget section to page
		Then User start editing "Video Player"
		...
		And User navigates to "/user/logout" from NAM
		When User navigates to "/" from NAM
