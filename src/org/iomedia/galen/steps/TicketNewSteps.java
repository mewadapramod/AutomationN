...
public class TicketNewSteps {
	...
	@Then("^User Verify character limit to notes field (.+)$")
	public void verifyCharacterLimitNotesField(String email) throws Exception {
		email = (String) base.getGDValue(email);
		ticketNew.enterRecipientDetailsandValidateNotesField(email);
	}
